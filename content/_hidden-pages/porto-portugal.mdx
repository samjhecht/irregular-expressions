...
<Box display="flex" maxWidth="lg" sx={{alignContent: 'center', justifyContent: 'center',}}>
    <Image
    src="/images/view_from_pont.jpeg"
    alt="View from Pont Luis I"
    width={200}
    height={300}
    caption="View from Pont Luis I"
...
<Box display="flex" maxWidth="lg" sx={{alignContent: 'center', justifyContent: 'center',}}>
    <Image
    src="/images/crystal_palace_gardens.jpg"
    alt="Crystal Palace Gardens"
    width={200}
    height={300}
    caption="Crystal Palace Gardens"
    style= {{ objectFit: 'cover'}}
    />
</Box>
...
<Box display="flex" maxWidth="lg" sx={{alignContent: 'center', justifyContent: 'center',}}>
    <Image
    src="/images/river_boats.jpeg"
    alt="Duoro River Boats"
    width={200}
    height={300}
    caption="Duoro River Boats"
    style= {{ objectFit: 'cover'}}
    />
</Box>
...
<Box display="flex" maxWidth="lg" sx={{alignContent: 'center', justifyContent: 'center',}}>
    <Image
    src="/images/douro_river_sunset.jpeg"
    alt="Duoro River Sunset Views"
    width={200}
    height={300}
    caption="Duoro River Sunset Views"
    style= {{ objectFit: 'cover'}}
    />
</Box>
...
<Box display="flex" maxWidth="lg" sx={{alignContent: 'center', justifyContent: 'center',}}>
    <Image
    src="/images/scooter_time.jpeg"
    alt="Scooter Time!"
    width={200}
    height={300}
    caption="Scooter Time!"
    style= {{ objectFit: 'cover'}}
    />
</Box>
