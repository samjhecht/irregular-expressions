...
We're all awash in startling articles lately about how mind-blowingly good ChatGPT is, about how it works, and how it's going to change our world.   There really is so much to process and I do confident that we're at a technological inflection point of greater significance than even the invention of the internet.   All the buzz is warranted and I expect we will be continuing to see an endless flow of articles about new industries being disrupted or augmented by the advent of large language models (LLMs) and other AI models.   However, amidst the frenzy of discussing how ChatGPT and other LLMs will change our world, I can't stop coming back to pondering what I believe is another fascinating (albeit unsettling) question that most people don't seem to be talking about - __*What does the power of ChatGPT say about us, the human brain and about our understanding of our reality?*__   
