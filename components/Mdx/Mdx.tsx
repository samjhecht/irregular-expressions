...
const ChakraLink = React.forwardRef<
  HTMLAnchorElement,
...
const MDXComponents: Record<
  string,
  React.FC<React.ComponentPropsWithRef<MdxComponentProps>>
> = {
  Box,
  Text,
  MdxImage,
  ...
  blockquote(props) {
    return <chakra.blockquote paddingX="6" {...props} />
  },
  hr(props) {
...
export default function Mdx({ code }: MdxProps) {
  const Component = useMDXComponentCustom(code, {
